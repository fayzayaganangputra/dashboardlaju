            ...
            <div className="flex items-start justify-between mb-6 pb-4 border-b-2 border-blue-600">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold text-blue-600">LAJU TUJU</h1>
                ...
                <div className="mt-4 text-sm text-gray-600">
                  ...
                  <p>Email: contact@lajutuju.com</p>
                </div>
              </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-blue-600 text-white text-sm font-semibold">
                      <th className="px-3 py-2 text-left border-r border-blue-500">Tipe Mobil</th>
                      <th className="px-3 py-2 text-center border-r border-blue-500">Unit</th>
                      <th className="px-3 py-2 text-center border-r border-blue-500">Hari</th>
                      <th className="px-3 py-2 text-right border-r border-blue-500">Harga/Hari</th>
